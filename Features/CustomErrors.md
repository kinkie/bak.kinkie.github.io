...
see [Translations
Project](https://wiki.squid-cache.org/action/show/Features/CustomErrors/Translations#)
...
**Squid-2.1 to
[Squid-3.1](https://wiki.squid-cache.org/action/show/Features/CustomErrors/Squid-3.1#)
only provide this macro code:**

  - %s  
    Absolute URL requested by client

**[Squid-3.2](https://wiki.squid-cache.org/action/show/Features/CustomErrors/Squid-3.2#)
...
[CategoryFeature](https://wiki.squid-cache.org/action/show/Features/CustomErrors/CategoryFeature#)
