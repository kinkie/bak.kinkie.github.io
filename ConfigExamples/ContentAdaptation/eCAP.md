...
## Using eCAP for GZip/DEFLATE support with Squid 3.x/4.x
  ...
  - *by
    [YuriVoinov](https://wiki.squid-cache.org/action/show/ConfigExamples/ContentAdaptation/eCAP/YuriVoinov#)*
...
Paste the configuration file like this:
  ...
  - ![{X}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-error.png)
    ...
    **[DatabaseDirectory](https://wiki.squid-cache.org/action/show/ConfigExamples/ContentAdaptation/eCAP/DatabaseDirectory#)**
