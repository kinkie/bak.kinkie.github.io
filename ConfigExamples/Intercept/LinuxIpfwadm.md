...
box use [policy
routing](https://wiki.squid-cache.org/action/show/ConfigExamples/Intercept/LinuxIpfwadm/ConfigExamples/Intercept/IptablesPolicyRoute#).
...
[CategoryConfigExample](https://wiki.squid-cache.org/action/show/ConfigExamples/Intercept/LinuxIpfwadm/CategoryConfigExample#)
