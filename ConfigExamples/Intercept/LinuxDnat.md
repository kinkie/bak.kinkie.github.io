...
box use [policy
routing](https://wiki.squid-cache.org/action/show/ConfigExamples/Intercept/LinuxDnat/ConfigExamples/Intercept/IptablesPolicyRoute#).
...
version 4](https://wiki.squid-cache.org/action/show/ConfigExamples/Intercept/LinuxDnat/Features/Tproxy4#).
...
[CategoryConfigExample](https://wiki.squid-cache.org/action/show/ConfigExamples/Intercept/LinuxDnat/CategoryConfigExample#)
