...
requests. Particularly when large objects are involved.
  ...
  - **[range\_offset\_limit](http://www.squid-cache.org/Doc/config/range_offset_limit#)**.
    ...
    anyway. With
    [Squid-3.2](https://wiki.squid-cache.org/action/show/SquidFaq/WindowsUpdate/Squid-3.2#)
...
error
"[WindowsUpdate](https://wiki.squid-cache.org/action/show/SquidFaq/WindowsUpdate/WindowsUpdate#)\_80072F8F"
or similar.
...
[Squid-3.4](https://wiki.squid-cache.org/action/show/SquidFaq/WindowsUpdate/Squid-3.4#)
and causes serious problems when using
[Squid-3.5](https://wiki.squid-cache.org/action/show/SquidFaq/WindowsUpdate/Squid-3.5#)
or above.
...
Back to the
[SquidFaq](https://wiki.squid-cache.org/action/show/SquidFaq/WindowsUpdate/SquidFaq#)
