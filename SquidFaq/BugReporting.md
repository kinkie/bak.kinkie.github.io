...
5.  Reproduce the failing transaction, using a single request if
    ...
    [squidclient](https://wiki.squid-cache.org/action/show/SquidFaq/BugReporting/SquidClientTool#),
...
[KnowledgeBase/DebugSections](https://wiki.squid-cache.org/action/show/SquidFaq/BugReporting/KnowledgeBase/DebugSections#).
...
Back to the
[SquidFaq](https://wiki.squid-cache.org/action/show/SquidFaq/BugReporting/SquidFaq#)
